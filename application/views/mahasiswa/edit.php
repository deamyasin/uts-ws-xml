...
<body>
	...
	<?php echo form_hidden('id', $dataMahasiswa->id); ?>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<table class="table table-bordered table-striped table-hover">
					...
					<tr>
						<td>ID</td>
						<td><?php echo form_input('', $mahasiswa->id, 'disabled'); ?></td>
					</tr>
					<tr>
						<td>Nama</td>
					...
					<tr>
						<td>NPM</td>
						<td><?php echo form_input('NPM', $mahasiswa->NPM); ?></td>
					</tr>
					<tr>
						<td>Email</td>
						<td><?php echo form_input('Email', $mahasiswa->Email); ?></td>
					</tr>
					<tr>
						<td>Alamat</td>
					...
					<tr>
						<td>NoHP</td>
						<td><?php echo form_input('Nomor', $mahasiswa->Nomor); ?></td>
					</tr>
					<tr>
						<td colspan="2">
